...
enum {
  APL_EXTRACT_SET,
  APL_EXTRACT_REAL,
  APL_EXTRACT_IMAGINARY,
  APL_EXTRACT_MAGNITUDE,
  APL_EXTRACT_PHASE
};

enum {
  APL_DRAW_LINES_ENUM,
  APL_DRAW_POINTS_ENUM,
  APL_DRAW_SCATTER_ENUM
};

#define APL_DRAW_SET		-1
#define APL_DRAW_NOTHING	0
#define APL_DRAW_LINES		(1 << APL_DRAW_LINES_ENUM)
#define APL_DRAW_POINTS		(1 << APL_DRAW_POINTS_ENUM)
#define APL_DRAW_SCATTER	(1 << APL_DRAW_SCATTER_ENUM)
